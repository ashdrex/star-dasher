...
bg2 = pg.image.load('background2.png')
bgX = 0
bgX2 = bg.get_width()
...
def showStart():
    startScreen = pg.image.load('startscreen.png')
...
def showEnd():
    ...
    while end:
        endScreen = pg.image.load('endscreen.png')
        titleFont = pg.font.Font('8bitpusab.ttf', 55)
...
class groundObj(object):
    groundStar = pg.image.load('groundObj.png')
